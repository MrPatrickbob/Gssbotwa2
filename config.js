...
global.ownername = "MrPatrickBloB";
global.owner = ['2349131631661'];
global.premium = ['2349131631661'];
...
global.mess = {
    ...
    botAdmin: '`I am not an admin... baka!`',
    owner: '`You are not my oni-chan`',
    group: '`You can use this command only in groups.. baka ❌`',
